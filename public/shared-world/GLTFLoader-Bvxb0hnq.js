import { $ as e, A as t, B as n, Bt as r, D as i, Dt as a, Et as o, F as s, G as c, Gt as l, H as u, I as d, It as f, K as p, M as m, Mt as h, N as g, Nt as _, P as v, Q as y, R as ee, St as te, T as b, U as ne, V as re, W as ie, Wt as x, X as ae, Y as S, _t as oe, a as se, at as C, bt as ce, c as w, ct as le, dt as ue, et as T, ft as de, g as E, h as D, ht as fe, i as pe, j as me, jt as he, k as ge, l as _e, lt as ve, m as ye, mt as be, ot as O, q as k, qt as A, r as xe, st as Se, ut as Ce, vt as we, x as Te, xt as j, yt as Ee, z as De, zt as M } from "./three.module-h2PuqYDi.js";
import { n as N } from "./BufferGeometryUtils-nus3RdMX.js";
//#region alien-archer-game-src/node_modules/three/examples/jsm/utils/SkeletonUtils.js
function Oe(e) {
...
//#endregion
//#region alien-archer-game-src/node_modules/three/examples/jsm/loaders/GLTFLoader.js
...
var I = {
	...
	_loadLight(e) {
		...
		if (r) return r;
		let i = t.json, a = ((i.extensions && i.extensions[this.name] || {}).lights || [])[e], o, s = new D(16777215);
		a.color !== void 0 && s.setRGB(a.color[0], a.color[1], a.color[2], c);
		...
		switch (a.type) {
			case "directional":
				...
				break;
			case "point":
				o = new oe(s), o.distance = l;
				break;
			case "spot":
				o = new f(s), o.distance = l, a.spot = a.spot || {}, a.spot.innerConeAngle = a.spot.innerConeAngle === void 0 ? 0 : a.spot.innerConeAngle, a.spot.outerConeAngle = a.spot.outerConeAngle === void 0 ? Math.PI / 4 : a.spot.outerConeAngle, o.angle = a.spot.outerConeAngle, o.penumbra = 1 - a.spot.innerConeAngle / a.spot.outerConeAngle, o.target.position.set(0, 0, -1), o.add(o.target);
				break;
			default: throw Error("THREE.GLTFLoader: Unexpected light type: " + a.type);
		}
		return o.position.set(0, 0, 0), Z(o, a), a.intensity !== void 0 && (o.intensity = a.intensity), o.name = t.createUniqueName(a.name || "light_" + e), r = Promise.resolve(o), t.cache.add(n, r), r;
	}
	getDependency(e, t) {
	...
	getMaterialType(e) {
		return F(this.parser, e, this.name) === null ? null : C;
	}
	extendMaterialParams(e, t) {
		let n = F(this.parser, e, this.name);
		...
		if (n.clearcoatFactor !== void 0 && (t.clearcoat = n.clearcoatFactor), n.clearcoatTexture !== void 0 && r.push(this.parser.assignTexture(t, "clearcoatMap", n.clearcoatTexture)), n.clearcoatRoughnessFactor !== void 0 && (t.clearcoatRoughness = n.clearcoatRoughnessFactor), n.clearcoatRoughnessTexture !== void 0 && r.push(this.parser.assignTexture(t, "clearcoatRoughnessMap", n.clearcoatRoughnessTexture)), n.clearcoatNormalTexture !== void 0 && (r.push(this.parser.assignTexture(t, "clearcoatNormalMap", n.clearcoatNormalTexture)), n.clearcoatNormalTexture.scale !== void 0)) {
			...
			t.clearcoatNormalScale = new x(e, e);
		}
		return Promise.all(r);
	}
}, Fe = class {
	...
	extendMaterialParams(e, t) {
		...
		if (n === null) return Promise.resolve();
		let r = [];
		if (t.sheenColor = new D(0, 0, 0), t.sheenRoughness = 0, t.sheen = 1, n.sheenColorFactor !== void 0) {
	...
	extendMaterialParams(e, t) {
		...
		return t.attenuationColor = new D().setRGB(i[0], i[1], i[2], c), Promise.all(r);
	}
}, Be = class {
	constructor(e) {
	...
	extendMaterialParams(e, t) {
		...
		return t.specularColor = new D().setRGB(i[0], i[1], i[2], c), n.specularColorTexture !== void 0 && r.push(this.parser.assignTexture(t, "specularColorMap", n.specularColorTexture, a)), Promise.all(r);
	}
}, He = class {
	constructor(e) {
	...
	createNodeMesh(e) {
		let n = this.parser.json, r = n.nodes[e];
		if (!r.extensions || !r.extensions[this.name] || r.mesh === void 0) return null;
		let i = n.meshes[r.mesh];
		for (let e of i.primitives) if (e.mode !== H.TRIANGLES && e.mode !== H.TRIANGLE_STRIP && e.mode !== H.TRIANGLE_FAN && e.mode !== void 0) return null;
		let a = r.extensions[this.name].attributes, o = [], s = {};
		...
		return o.length < 1 ? null : (o.push(this.parser.createNodeMesh(e)), Promise.all(o).then((e) => {
			let n = e.pop(), r = n.isGroup ? n.children : [n], i = e[0].count, a = [];
			for (let e of r) {
				let n = new y(), r = new l(), o = new j(), c = new l(1, 1, 1), u = new me(e.geometry, e.material, i);
				for (let e = 0; e < i; e++) s.TRANSLATION && r.fromBufferAttribute(s.TRANSLATION, e), s.ROTATION && o.fromBufferAttribute(s.ROTATION, e), s.SCALE && c.fromBufferAttribute(s.SCALE, e), u.setMatrixAt(e, n.compose(r, o, c));
				for (let n in s) if (n === "_COLOR_0") {
					let e = s[n];
					u.instanceColor = new t(e.array, e.itemSize, e.normalized);
				} else n !== "TRANSLATION" && n !== "ROTATION" && n !== "SCALE" && e.geometry.setAttribute(n, s[n]);
				de.prototype.copy.call(u, e), this.parser.assignFinalMaterial(u), a.push(u);
			}
			return n.isGroup ? (n.clear(), n.add(...a), n) : a[0];
		}));
	}
}, R = "glTF", z = 12, B = {
	JSON: 1313821514,
	...
	decodePrimitive(e, t) {
		let n = this.json, r = this.dracoLoader, i = e.extensions[this.name].bufferView, a = e.extensions[this.name].attributes, o = {}, s = {}, l = {};
		for (let e in a) {
		...
		for (let t in e.attributes) {
			...
			if (a[t] !== void 0) {
				...
				l[r] = U[i.componentType].name, s[r] = i.normalized === !0;
			}
		}
...
function tt(e) {
	return e.DefaultMaterial === void 0 && (e.DefaultMaterial = new O({
		color: 16777215,
		emissive: 0,
		metalness: 1,
		roughness: 1,
...
var ot = new y(), st = class {
	constructor(e = {}, t = {}) {
		this.json = e, this.extensions = {}, this.plugins = {}, this.options = t, this.cache = new Ae(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.nodeCache = {}, this.meshCache = {
			refs: {},
			uses: {}
		}, this.cameraCache = {
			refs: {},
		...
		if (typeof navigator < "u" && navigator.userAgent !== void 0) {
			...
			i = n && t ? parseInt(t[1], 10) : -1, a = e.indexOf("Firefox") > -1, o = a ? e.match(/Firefox\/([0-9]+)\./)[1] : -1;
		}
		typeof createImageBitmap > "u" || n && i < 17 || a && o < 98 ? this.textureLoader = new r(this.options.manager) : this.textureLoader = new ge(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new b(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(!0);
	}
	setExtensions(e) {
		this.extensions = e;
	}
	...
	loadAccessor(e) {
		...
		if (r.bufferView === void 0 && r.sparse === void 0) {
			let e = K[r.type], t = U[r.componentType], n = r.normalized === !0, i = new t(r.count * e);
			return Promise.resolve(new w(i, e, n));
		}
		let i = [];
		return r.bufferView === void 0 ? i.push(null) : i.push(this.getDependency("bufferView", r.bufferView)), r.sparse !== void 0 && (i.push(this.getDependency("bufferView", r.sparse.indices.bufferView)), i.push(this.getDependency("bufferView", r.sparse.values.bufferView))), Promise.all(i).then(function(e) {
			let i = e[0], a = K[r.type], o = U[r.componentType], s = o.BYTES_PER_ELEMENT, c = s * a, l = r.byteOffset || 0, u = r.bufferView === void 0 ? void 0 : n.bufferViews[r.bufferView].byteStride, d = r.normalized === !0, f, p;
			if (u && u !== c) {
				let e = Math.floor(l / u), n = "InterleavedBuffer:" + r.bufferView + ":" + r.componentType + ":" + e + ":" + r.count, c = t.cache.get(n);
				c || (f = new o(i, e * u, r.count * u / s), c = new m(f, u / s), t.cache.add(n, c)), p = new g(c, a, l % u / s, d);
			} else f = i === null ? new o(r.count * a) : new o(i, l, r.count * a), p = new w(f, a, d);
			if (r.sparse !== void 0) {
				let t = K.SCALAR, n = U[r.sparse.indices.componentType], s = r.sparse.indices.byteOffset || 0, c = r.sparse.values.byteOffset || 0, l = new n(e[1], s, r.sparse.count * t), u = new o(e[2], c, r.sparse.count * a);
				i !== null && (p = new w(p.array.slice(), p.itemSize, p.normalized)), p.normalized = !1;
	...
	loadTextureImage(e, t, n) {
		...
		let c = this.loadImageSource(t, n).then(function(t) {
			...
			return t.magFilter = W[n.magFilter] || 1006, t.minFilter = W[n.minFilter] || 1008, t.wrapS = G[n.wrapS] || 1e3, t.wrapT = G[n.wrapT] || 1e3, t.generateMipmaps = !t.isCompressedTexture && t.minFilter !== 1003 && t.minFilter !== 1006, r.associations.set(t, { textures: e }), t;
		}).catch(function() {
			return null;
		});
	...
	assignFinalMaterial(e) {
		...
		if (e.isPoints) {
			...
			t || (t = new Ee(), S.prototype.copy.call(t, n), t.color.copy(n.color), t.map = n.map, t.sizeAttenuation = !1, this.cache.add(e, t)), n = t;
		} else if (e.isLine) {
			let e = "LineBasicMaterial:" + n.uuid, t = this.cache.get(e);
			t || (t = new De(), S.prototype.copy.call(t, n), t.color.copy(n.color), t.map = n.map, this.cache.add(e, t)), n = t;
		}
		if (r || i || a) {
	...
	loadMaterial(e) {
		let t = this, n = this.json, r = this.extensions, i = n.materials[e], o, s = {}, l = i.extensions || {}, u = [];
		if (l[I.KHR_MATERIALS_UNLIT]) {
			let e = r[I.KHR_MATERIALS_UNLIT];
			o = e.getMaterialType(), u.push(e.extendParams(s, i, t));
		} else {
			let n = i.pbrMetallicRoughness || {};
			if (s.color = new D(1, 1, 1), s.opacity = 1, Array.isArray(n.baseColorFactor)) {
				let e = n.baseColorFactor;
				s.color.setRGB(e[0], e[1], e[2], c), s.opacity = e[3];
			}
			n.baseColorTexture !== void 0 && u.push(t.assignTexture(s, "map", n.baseColorTexture, a)), s.metalness = n.metallicFactor === void 0 ? 1 : n.metallicFactor, s.roughness = n.roughnessFactor === void 0 ? 1 : n.roughnessFactor, n.metallicRoughnessTexture !== void 0 && (u.push(t.assignTexture(s, "metalnessMap", n.metallicRoughnessTexture)), u.push(t.assignTexture(s, "roughnessMap", n.metallicRoughnessTexture))), o = this._invokeOne(function(t) {
		...
		let d = i.alphaMode || Y.OPAQUE;
		if (d === Y.BLEND ? (s.transparent = !0, s.depthWrite = !1) : (s.transparent = !1, d === Y.MASK && (s.alphaTest = i.alphaCutoff === void 0 ? .5 : i.alphaCutoff)), i.normalTexture !== void 0 && o !== T && (u.push(t.assignTexture(s, "normalMap", i.normalTexture)), s.normalScale = new x(1, 1), i.normalTexture.scale !== void 0)) {
			let e = i.normalTexture.scale;
			s.normalScale.set(e, e);
		}
		if (i.occlusionTexture !== void 0 && o !== T && (u.push(t.assignTexture(s, "aoMap", i.occlusionTexture)), i.occlusionTexture.strength !== void 0 && (s.aoMapIntensity = i.occlusionTexture.strength)), i.emissiveFactor !== void 0 && o !== T) {
			let e = i.emissiveFactor;
			s.emissive = new D().setRGB(e[0], e[1], e[2], c);
		}
		return i.emissiveTexture !== void 0 && o !== T && u.push(t.assignTexture(s, "emissiveMap", i.emissiveTexture, a)), Promise.all(u).then(function() {
			let n = new o(s);
	...
	loadGeometries(e) {
		...
		for (let n = 0, o = e.length; n < o; n++) {
			let o = e[n], s = it(o), c = r[s];
			if (c) a.push(c.promise);
			else {
				let e;
				e = o.extensions && o.extensions[I.KHR_DRACO_MESH_COMPRESSION] ? i(o) : lt(new _e(), o, t), r[s] = {
					primitive: o,
					promise: e
				}, a.push(e);
			}
	...
	loadMesh(t) {
		let r = this, a = this.json, o = this.extensions, s = a.meshes[t], c = s.primitives, l = [];
		for (let e = 0, t = c.length; e < t; e++) {
			let t = c[e].material === void 0 ? tt(this.cache) : this.getDependency("material", c[e].material);
			l.push(t);
		}
		return l.push(r.loadGeometries(c)), Promise.all(l).then(function(a) {
			let l = a.slice(0, a.length - 1), u = a[a.length - 1], d = [];
			for (let i = 0, a = u.length; i < a; i++) {
				let a = u[i], f = c[i], p, m = l[i];
				if (f.mode === H.TRIANGLES || f.mode === H.TRIANGLE_STRIP || f.mode === H.TRIANGLE_FAN || f.mode === void 0) p = s.isSkinnedMesh === !0 ? new h(a, m) : new e(a, m), p.isSkinnedMesh === !0 && p.normalizeSkinWeights(), f.mode === H.TRIANGLE_STRIP ? p.geometry = N(p.geometry, 1) : f.mode === H.TRIANGLE_FAN && (p.geometry = N(p.geometry, 2));
				else if (f.mode === H.LINES) p = new re(a, m);
				else if (f.mode === H.LINE_STRIP) p = new ee(a, m);
				else if (f.mode === H.LINE_LOOP) p = new n(a, m);
				else if (f.mode === H.POINTS) p = new we(a, m);
				else throw Error("THREE.GLTFLoader: Primitive mode unsupported: " + f.mode);
				Object.keys(p.geometry.morphAttributes).length > 0 && rt(p, s), p.name = r.createUniqueName(s.name || "mesh_" + t), Z(p, s), f.extensions && X(o, p, f), r.assignFinalMaterial(p), d.push(p);
			}
			for (let e = 0, n = d.length; e < n; e++) r.associations.set(d[e], {
				meshes: t,
				primitives: e
			});
			if (d.length === 1) return s.extensions && X(o, d[0], s), d[0];
			let f = new i();
			s.extensions && X(o, f, s), r.associations.set(f, { meshes: t });
			for (let e = 0, t = d.length; e < t; e++) f.add(d[e]);
			return f;
		});
	}
	loadCamera(e) {
		...
		return n.type === "perspective" ? t = new fe(ae.radToDeg(r.yfov), r.aspectRatio || 1, r.znear || 1, r.zfar || 2e6) : n.type === "orthographic" && (t = new be(-r.xmag, r.xmag, r.ymag, -r.ymag, r.znear, r.zfar)), n.name && (t.name = this.createUniqueName(n.name)), Z(t, n), Promise.resolve(t);
	}
	loadSkin(e) {
	...
	loadNode(e) {
		...
		return Promise.all([
			...
			if (t.userData.pivot !== void 0 && n.length > 0) {
				...
				t.pivot = new l().fromArray(e), t.position.x -= e[0], t.position.y -= e[1], t.position.z -= e[2], r.position.set(0, 0, 0), delete t.userData.pivot;
			}
			return t;
		});
	}
	_loadNodeShallow(e) {
		...
		return c && s.push(c), a.camera !== void 0 && s.push(r.getDependency("camera", a.camera).then(function(e) {
			...
			let s;
			if (s = a.isBone === !0 ? new pe() : t.length > 1 ? new i() : t.length === 1 ? t[0] : new de(), s !== t[0]) for (let e = 0, n = t.length; e < n; e++) s.add(t[e]);
			if (a.name && (s.userData.name = a.name, s.name = o), Z(s, a), a.extensions && X(n, s, a), a.matrix !== void 0) {
				let e = new y();
	...
	loadScene(e) {
		let t = this.extensions, n = this.json.scenes[e], r = this, a = new i();
		n.name && (a.name = r.createUniqueName(n.name)), Z(a, n), n.extensions && X(t, a, n);
		let o = n.nodes || [], s = [];
		for (let e = 0, t = o.length; e < t; e++) s.push(r.getDependency("node", o[e]));
		return Promise.all(s).then(function(e) {
			for (let t = 0, n = e.length; t < n; t++) {
				let n = e[t];
				n.parent === null ? a.add(n) : a.add(Oe(n));
			}
			return r.associations = ((e) => {
				let t = /* @__PURE__ */ new Map();
				for (let [e, n] of r.associations) (e instanceof S || e instanceof M) && t.set(e, n);
				return e.traverse((e) => {
	...
	_createAnimationTracks(e, t, n, r, i) {
		...
		let u = r.interpolation === void 0 ? d : et[r.interpolation], f = this._getArrayFromAccessor(n);
		for (let e = 0, n = s.length; e < n; e++) {
			let n = new l(s[e] + "." + J[i.path], t.array, f, u);
	...
	_createCubicSplineTrackInterpolant(e) {
		e.createInterpolant = function(e) {
			return new (this instanceof te ? $e : V)(this.times, this.values, this.getValueSize() / 3, e);
...
function ct(e, t, n) {
	...
	if (r.POSITION !== void 0) {
		...
		if (t !== void 0 && a !== void 0) {
			if (i.set(new l(t[0], t[1], t[2]), new l(a[0], a[1], a[2])), e.normalized) {
...
function lt(e, t, n) {
	...
	return E.workingColorSpace !== "srgb-linear" && "COLOR_0" in r && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${E.workingColorSpace}" not supported.`), Z(e, t), ct(e, t, n), Promise.all(i).then(function() {
