...
with zipfile.ZipFile(output) as archive:
    for needed in ['App/Triptotropic.exe','App/resources/app/main.cjs','Site/dist/server/index.js','Site/public/models/brain-room.glb','Guide/START HERE.html','Tools/node.exe','Tools/dependency-links.json']:
        if root.name+'/'+needed not in archive.namelist() and needed!='Site/public/models/brain-room.glb': raise RuntimeError('Missing '+needed)
    bad=archive.testzip()
