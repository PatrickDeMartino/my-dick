...
/** Antarctica is the one territory that is actually open, exactly as before. */
const ANTARCTICA: Territory = { name: "Antarctica", center: [0, -84], unlocked: true };
...
function Globe({ onEnter }: { onEnter: () => void }) {
  ...
  const territories = useMemo<Territory[]>(
    () => [
      ...continentMarkers.map((continent) => ({ name: continent.name, center: continent.center, unlocked: false })),
      ANTARCTICA,
    ],
    [],
  );
  ...
  return (
    <main className="world-screen">
      ...
      <footer className="world-footer">
        ...
        <div className="control-hint"><span>🏹</span><p><b>WASD</b><small>MOVE SCOUT · CLICK TO LOOSE</small></p></div>
