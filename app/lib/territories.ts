import type { Territory as GlobeTerritory, Point } from "../urf-3d/globe3d";
...
export const TERRITORY_BOXES: TerritoryBox[] = [
  ...
  { name: "Himalayas", pin: true, unlocked: false, center: [84, 29.5], west: 72.5, east: 96.2, south: 26.4, north: 37.2 },
  { name: "India", pin: true, unlocked: false, center: [79, 22], west: 68, east: 89.5, south: 6.6, north: 35.6 },
  { name: "Southeast Asia", pin: true, unlocked: false, center: [115, 8], west: 92, east: 141, south: -11.2, north: 23.4 },
  { name: "China", pin: true, unlocked: false, center: [104, 35], west: 73.4, east: 134.8, south: 18.1, north: 53.6 },
  { name: "Australia", pin: true, unlocked: false, center: [134, -25], west: 112, east: 154, south: -44, north: -10 },
  ...
  { name: "North America", pin: true, unlocked: false, center: [-100, 45], west: -168, east: -52, south: 14, north: 84 },
